...
describe('channel', () => describe.each<TestSuite>([
	{
		name: 'UnboundedChannel',
		make: <T>() => new UnboundedChannel<T>() },
	{
		name: 'BoundedChannel',
	...
	it('stops async iterate on channel close', async () => {
		const expected = [42, 36]
